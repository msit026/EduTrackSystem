...
public class Registrations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(role.equalsIgnoreCase("Student"))
		{
			...
			String str = "UPDATE ets_student_details set sd_email='"+emailId +"',sd_password='"+password+"',sd_dob='"+dob+"',sd_phone='"+mobileno+"',sd_address='"+address+"',sd_gender='"+ gender+"',sd_program='"+ programme+"',sd_status='"+ flag+"',sd_admitted_year='"+ year+"' where sd_student_id='"+ ID+"' ;" ;
			...
			if(value > 0) 
				System.out.println("Inserted student details Successfully....");
			else 
				System.out.println("Problem in student details Insertion....");
		}
