						...
						<table>
							<tr>
								<td><input type="password" id="oldPassword"
									name="oldPassword"
									onchange="checkPassword('<%=request.getAttribute("oldPassword")%>')"
									placeholder="Current Password"></input></td>
							</tr>
							<tr>
								<td><input type="password" id="newPassword"
									name="newPassword" placeholder="New Password"></input></td>
							</tr>
							<tr>
								<td><input type="password" id="confirmPassword"
									name="confirmPassword" placeholder="Confirm Password"
									onchange="matchPassword()"></input></td>
							</tr>
							<tr>
								<td><input type="submit" id="buttonSubmit"
									name="buttonSubmit" value="Change" /></td>
							</tr>
						</table>
				</form>
				<%
